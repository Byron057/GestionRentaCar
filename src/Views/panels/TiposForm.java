 ...
 * @author PC
 */
public class TiposForm extends javax.swing.JDialog {
     ...
     */
    public TiposForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void cargarDatosEdicion(String id, String tipo, String estado) {
        ...
        flTipo.setText(tipo);
        flTipo.setForeground(new java.awt.Color(60, 60, 60));
        
        cbxTipo.setSelectedItem(estado);
    }
    
    private void configurarPlaceholders() {
        aplicarPlaceholder(flTipo, "Ingrese el Tipo");
    }
    ...
    private void initComponents() {
        ...
        cbxTipo = new assets.ComboBoxRound();
        panelRound11 = new assets.PanelRound();
        flTipo = new javax.swing.JTextField();
        ...
        flTipo.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        flTipo.setForeground(new java.awt.Color(204, 204, 204));
        flTipo.setText("jTextField1");
        flTipo.setBorder(null);
        flTipo.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                flTipoMouseClicked(evt);
            }
        });
        panelRound11.add(flTipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 10, 220, 20));
    ...
    private void flTipoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_flTipoMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_flTipoMouseClicked
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                TiposForm dialog = new TiposForm(new javax.swing.JFrame(), true);
